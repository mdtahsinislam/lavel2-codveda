...
// //C:\Web-Development\Codvata\Bismillah\lavel-1\lavel2\lavel2\app\login\page.tsx
// "use client";
...
//       <form className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-md border border-gray-100 text-center">
...
//           type="button"
//           onClick={handleGoogleLogin}
//           className="w-full mt-4 border py-2 rounded flex justify-center items-center gap-2"
//         >
//           <FcGoogle size={20} />
//           Login with Google
//         </button>
...
//         <div className="mb-6 text-left">
//           <label>Password</label> {/* Password add ice button to see password or hide password*/}
//           <input
//             type="password"
//             name="password"
//             value={formData.password}
...
////i successfully sand name;email;password;phone;photo this information in mongodb 
//  now i want to sand google login information in mongodb and secure login system
